  ...
  <div class="wrapper">
    ...
    >
      <ul class="nav sidemenu mt-5">
        ...
        <li class="pl-lg-3 pl-md-1 nav-item" :class="{'active': $route.path == '/' || $route.path == '/fundraiser/companyprofile' || $route.path == '/fundraiser/createprofile'}">
        ...
        <li
          ...
          :class="{'active': $route.path == '/fundraiser/projectlisting' || $route.path == '/fundraiser/viewproject' || $route.path == '/fundraiser/createproject'}"
        >
          <a
            class="nav-link py-3"
            href="#repo"
        ...
        <li
          class="pl-lg-3 pl-md-1 nav-item"
          :class="{'active': $route.path == '/fundraiser/userprofile' || $route.path == '/fundraiser/viewuser'}"
        >
          <router-link to="/fundraiser/viewuser" class="nav-link py-3">
            <span class="mr-3">
        ...
        >
          <router-link to="/fundraiser/messages" class="nav-link d-flex py-3">
            ...
            <span>Messages</span>
            <span class="ml-auto">
              <p class="notific">12</p>
            </span>
          </router-link>
        </li>
      </ul>
      <ul class="sidemenu nav mt-5">
        <li class="pl-lg-3 pl-md-1 nav-item">
    ...
    <main class="main col-lg-10 col-xs-12 offset-lg-2 col-md-12 px-0">
      <header class="main-head sticky-top py-lg-2">
        <nav class="navbar navbar-light">
          <div class="navbar-toggle d-inline">
            <button
              ...
              @click="openSide"
            >
              <span class="navbar-toggle-bar bar1"></span>
              <span class="navbar-toggle-bar bar2"></span>
              <span class="navbar-toggle-bar bar3"></span>
            </button>
          </div>
        </nav>
        <nav>
          <div
            class="collapse navbar-collapse w-100 d-lg-none"
            style="margin-top: +10px;"
            id="navbarSupportedContent"
          >
            <ul class="nav mobmenu">
              ...
              <li class="pl-3 nav-item">
                ...
                <div class="collapse" id="repo">
                  <ul class="nav flex-column submenu">
                    <li class="pl-4 nav-item">
                      <router-link to="/createprojects" class="pl-4 nav-link">Create Projects</router-link>
                    </li>
                    <li class="pl-4 nav-item">
                      <router-link to="/projectlist" class="pl-4 nav-link">Project Pipeline</router-link>
                    </li>
                  </ul>
                </div>
              </li>
              ...
              <li class="pl-3 nav-item">
                <router-link to="/messages" class="nav-link d-flex">
                  <span class="mr-3">
                    <img width="20px" src="../../public/img/messages.svg" />
                  </span>
                  <span>Messages</span>
                  <span class="ml-auto">
                    <p class="notific">12</p>
...
export default {
  methods: {
    openSide() {
      ...
      $("main")
        .toggleClass("col-lg-10 offset-lg-2 ")
        .toggleClass(
          "col-lg-12 offset-lg-0 col-md-12 offset-md-0 col-sm-12 offset-sm-0"
        );
      $("div#footerr")
        .toggleClass("col-lg-10 offset-lg-2 ")
        .toggleClass(
